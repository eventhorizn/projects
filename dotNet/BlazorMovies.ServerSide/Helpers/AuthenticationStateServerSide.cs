...
{
    public class AuthenticationStateServerSide : IAuthenticationStateService
    {
        private readonly AuthenticationStateProvider authenticationStateProvider;

        public AuthenticationStateServerSide(AuthenticationStateProvider authenticationStateProvider)
        {
